  ...
  return (
    <div className="h-[91vh] grid content-center gap-12 text-white font-poppins w-full text-center">
      ...
      <div className="flex justify-center gap-16 text-black font-semibold ">
        <Link href="/quiz">
          <div className="bg-gradient-to-tr from-[#E7E0C6] to-[#CE8FFF] p-4 cursor-pointer rounded-[45px] hover:scale-110 transition duration-500 transition-all ">
            Tell me your feeling
          </div>
          f
        </Link>
        <Link href="/face-recognition">
          <div className="bg-gradient-to-br from-[#E7E0C6] to-[#3C57C4] p-4 cursor-pointer rounded-[45px] hover:scale-110 transition duration-500 transition-all">
